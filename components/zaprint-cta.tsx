    ...
    <section className="w-full pt-20 md:pt-32 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-8 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-3xl md:text-5xl lg:text-6xl font-semibold leading-tight text-balance max-w-xl">
        ...
        <Link href="/signup">
          <Button
            className="px-8 py-3 bg-primary text-primary-foreground text-base font-medium rounded-full shadow-lg shadow-primary/25 hover:bg-primary/90 transition-all duration-200 flex items-center gap-2"
            size="lg"
          >
            Get Started Free
