...
export interface GlassmorphismTrustHeroProps {
  ...
  /** When true, use the interactive shader background instead of image */
  useShaderBackground?: boolean;
}

const DEFAULT_BACKGROUND =
  "https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=1600&q=80";
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 md:pt-32 md:pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <h1
              className="animate-fade-in-hero delay-200 text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-medium tracking-tighter leading-[0.9]"
              style={{
                maskImage:
            ...
            <p className="animate-fade-in-hero delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              {description}
            </p>

            <div className="animate-fade-in-hero delay-400 flex flex-col sm:flex-row gap-4">
              <Link
                href={primaryCtaHref}
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            <div className="animate-fade-in-hero delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
            ...
            <div className="animate-fade-in-hero delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              ...
              >
                <div className="animate-marquee-hero flex gap-12 whitespace-nowrap px-4">
